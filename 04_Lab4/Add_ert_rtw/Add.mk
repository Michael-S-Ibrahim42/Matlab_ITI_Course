...
## 
## Makefile     : Add.mk
## Generated on : Sun Jan 30 23:01:21 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Add.elf
...
START_DIR                 = A:/00_SHIELD/02_Codes/10_Matlab/Matlab_ITI_Course/04_Lab4
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Add.elf
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -D_MW_ARDUINO_LOOP_=1 -DMW_ARDUINO_STEP_SIZE=1000000 -DMW_ARDUINO_MICROS -DARDUINO_NUM_SERIAL_PORTS=1 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_ANALOG_REF_=0
...
OBJS = Add.o Add_data.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
Add.o : $(START_DIR)/Add_ert_rtw/Add.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Add_data.o : $(START_DIR)/Add_ert_rtw/Add_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Add_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"

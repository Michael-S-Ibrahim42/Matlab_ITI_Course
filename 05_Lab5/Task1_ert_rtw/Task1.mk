...
## 
## Makefile     : Task1.mk
## Generated on : Thu Feb 10 18:01:22 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Task1.elf
...
START_DIR                 = A:/00_SHIELD/02_Codes/10_Matlab/Matlab_ITI_Course/05_Lab5
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH        = C:/Users/mmich/DOCUME~1/MATLAB/R2021a/ARDUIN~1/ARDUIN~1/FASTER~2
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Task1.elf
...
OBJS = Task1.o Task1_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/Task1_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Task1_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
Task1.o : $(START_DIR)/Task1_ert_rtw/Task1.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Task1_data.o : $(START_DIR)/Task1_ert_rtw/Task1_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Task1_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/Task1_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/Task1_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/Task1_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"

...
## 
## Makefile     : Task2.mk
## Generated on : Thu Feb 10 18:40:28 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Task2.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Task2.elf
...
OBJS = Task2.o Task2_data.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/Task2_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Task2_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
Task2.o : $(START_DIR)/Task2_ert_rtw/Task2.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Task2_data.o : $(START_DIR)/Task2_ert_rtw/Task2_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Task2_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
